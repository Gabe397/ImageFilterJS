...
Array.isArray || (Array.isArray = function (e) {
    ...
    var s, e, f = "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== f ? f : {},
        n = !f.document && !!f.postMessage, o = n && /(\?|&)papaworker(=|&|$)/.test(f.location.search), a = !1, h = {},
        u = 0, k = {
            parse: function (e, t) {
            ...
            function e() {
                if (0 !== h.length) {
                    ...
                    if (z(o.before)) {
                        ...
                        if ("object" == typeof s) {
                            if ("abort" === s.action) return e = "AbortError", t = n.file, r = n.inputElem, i = s.reason, void (z(o.error) && o.error({name: e}, t, r, i));
    ...
    function r(g) {
        var a, o, h, i = /^\s*-?(\d*\.?\d+|\d+\.?\d*)(e[-+]?\d+)?\s*$/i,
            ...
            t = this, r = 0, s = 0, u = !1, e = !1, f = [], d = {data: [], errors: [], meta: {}};
        if (z(g.step)) {
            var l = g.step;
            g.step = function (e) {
                if (d = e, p()) c(); else {
        ...
        function c() {
            if (d && h && (y("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + k.DefaultDelimiter + "'"), h = !1), g.skipEmptyLines) for (var e = 0; e < d.data.length; e++) m(d.data[e]) && d.data.splice(e--, 1);
            return p() && function () {
                if (!d) return;
        ...
        this.parse = function (e, t, r) {
            ...
            if (g.newline || (g.newline = function (e, t) {
                ...
                var r = new RegExp(M(t) + "([^]*?)" + M(t), "gm"), i = (e = e.replace(r, "")).split("\r"),
            ...
            var s = E(g);
            return g.preview && g.header && s.preview++, a = e, o = new v(s), d = o.parse(a, t, r), c(), u ? {meta: {paused: !0}} : d || {meta: {paused: !1}}
    ...
    function v(e) {
        var S, O = (e = e || {}).delimiter, x = e.newline, T = e.comments, I = e.step, A = e.preview, D = e.fastMode,
        ...
        this.parse = function (i, t, r) {
            ...
            function C(e) {
                return {
                    data: h,
                    errors: u,
                    meta: {delimiter: O, linebreak: x, aborted: F, truncated: !!e, cursor: d + (t || 0)}
                }
            }
    ...
    return o ? f.onmessage = function (e) {
        ...
        if ("string" == typeof t.input) f.postMessage({
            ...
            r && f.postMessage({workerId: k.WORKER_ID, results: r, finished: !0})
        }
